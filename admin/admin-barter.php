...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/barter.css">
    <link rel="stylesheet" href="../assets/css/styless.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css" integrity="sha512-Kc323vGBEqzTmouAECnVceyQqyqdsSiqLQISBL29aUW4U/M7pSPA/gEUZQqv1cwx4OnYxTxve5UMg5GT6L4JJg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="icon" href="../assets/images/phy_logo.jpeg">

</head>
<body>
<div class="page-wrapper">
      <section class="header">
        <a href="../public/home.html" class="logo"><img src="../assets/images/phy_logo.jpeg" alt=""></a>

        <div class="nav-links">
            <ul>
                <li><a href="admin.php">Dashboard</a></li>
                <li><a href="admin-exp.html">Experiments</a></li>
                <li><a class="active" href="admin-barter.php">Barter</a></li>
    ...
    <?php if (mysqli_num_rows($result) > 0): ?>
        <?php while($row = mysqli_fetch_assoc($result)): ?>
            <div class="card">
                ...
                <a href="admin-delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this post?');" class="btnn" style="background-color: crimson; color: white; padding: 6px 12px; margin:0; margin-top: 10px; display: inline-block;">Delete</a>
            </div>
        <?php endwhile; ?>
    <?php else: ?>
...
<script>
    function fetchBarterPosts() {
      ...
      fetch('../actions/fetch_posts.php?' + query)
